  ...
  !function(t2, e2) {
    ...
    var _ = function() {
      ...
      return m2.parse = function(t3) {
        ...
        var n3, o3 = O.p(t3), h2 = "set" + (this.$u ? "UTC" : ""), $2 = (n3 = {}, n3[a] = h2 + "Date", n3[d] = h2 + "Date", n3[f2] = h2 + "Month", n3[c] = h2 + "FullYear", n3[u] = h2 + "Hours", n3[s] = h2 + "Minutes", n3[i] = h2 + "Seconds", n3[r] = h2 + "Milliseconds", n3)[o3], l2 = o3 === a ? this.$D + (e3 - this.$W) : e3;
        if (o3 === f2 || o3 === c) {
        ...
        return D2 = (l2 = {}, l2[c] = D2 / 12, l2[f2] = D2, l2[h] = D2 / 3, l2[o2] = (g2 - m3) / 6048e5, l2[a] = (g2 - m3) / 864e5, l2[u] = g2 / n2, l2[s] = g2 / e2, l2[i] = g2 / t2, l2)[y2] || g2, $2 ? D2 : O.a(D2);
    ...
    return w.prototype = b, [["$ms", r], ["$s", i], ["$m", s], ["$H", u], ["$W", a], ["$M", f2], ["$y", c], ["$D", d]].forEach(function(t3) {
      b[t3[1]] = function(e3) {
  ...
  !function(r, e2) {
    ...
    return function(r, e2, t2) {
      ...
      t2.en.relativeTime = o2, n2.fromToBase = function(e3, n3, i2, d2, u) {
        for (var f2, a, s, l = i2.$locale().relativeTime || o2, h = r.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m = h.length, c = 0; c < m; c += 1) {
          var y = h[c];
          y.d && (f2 = d2 ? t2(e3).diff(i2, y.d, true) : i2.diff(e3, y.d, true));
          var p2 = (r.rounding || Math.round)(Math.abs(f2));
          if (s = f2 > 0, p2 <= y.r || !y.r) {
            p2 <= 1 && c > 0 && (y = h[c - 1]);
            var v = l[y.l];
            u && (p2 = u("" + p2)), a = typeof v == "string" ? v.replace("%d", p2) : v(p2, n3, y.l, s);
            break;
          }
        }
        if (n3)
